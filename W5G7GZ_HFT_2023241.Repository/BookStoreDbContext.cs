    ...
    public class BookStoreDbContext : DbContext // used Microsoft.EntityFrameworkCore 5.0.11
    {
        ...
        .HasKey(b => b.BookID);
         ...
         .OnDelete(DeleteBehavior.SetNull);
            ...
            Book book1_ = new Book(2, 1, 1, 4290, "1984", "Dystopic Fiction", "9780451524935", DateTime.Parse("1949.06.08"));
            Book book2 = new Book(3, 1, 2, 3990, "Animal Farm", "Allegorical Novella", "9780451524936", DateTime.Parse("1945.08.17"));
            ...
            Book book5 = new Book(6, 2, 2, 3790, "The Doors of Perception", "Philosophical", "9780060850525", DateTime.Parse("1954.05.04"));
            ...
            Book book10 = new Book(11, 4, 4, 2490, "Egri csillagok", "Historical Novel", "9789639683107", DateTime.Parse("1899.01.01"));
            Book book11 = new Book(12, 4, 4, 1990, "Lámpás", "Novel", "9789638163394", DateTime.Parse("1901.01.01"));
            Book book12 = new Book(13, 4, 4, 2290, "A láthatatlan ember", "Novel", "9789635546073", DateTime.Parse("1930.01.01"));
            Book book13 = new Book(14, 5, 5, 1990, "The Choice: Embrace the Possible", "Biography", "9781501130786", DateTime.Parse("2017.09.05"));
            Book book14 = new Book(15, 5, 5, 2490, "The Gift: 12 Lessons to Save Your Life", "Self.Help", "9781984800406", DateTime.Parse("2020.09.15"));
